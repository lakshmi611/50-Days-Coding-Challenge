...
SELECT 
region,
AVG(CASE WHEN smoker = 'Yes' THEN insurance_cost END) AS smoker_cost,
AVG(CASE WHEN smoker = 'No' THEN insurance_cost END) AS non_smoker_cost,
AVG(CASE WHEN smoker = 'Yes' THEN insurance_cost END) -
AVG(CASE WHEN smoker = 'No' THEN insurance_cost END) AS difference
FROM medical_insurance
GROUP BY region;